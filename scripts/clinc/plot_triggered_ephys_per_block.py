...
file_name_list = ['MB_1700670158_174163', 'MB_1700671568_714180', 'MB_1700672668_26337', 'MB_1700673350_780580']
...
for file_name in file_name_list:
    ...
    pdf_path = folder_path / "figures" / (file_name + '_epoched_reref_lfp_per_pulse.pdf')
    group_features = ['eid', 'pw']
    relplot_kwargs = dict(estimator='mean', errorbar='se', hue='amp')
