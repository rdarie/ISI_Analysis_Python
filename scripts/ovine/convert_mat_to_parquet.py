...
folder_name = "202309281300-Phoenix"
block_idx_list = [1, 2, 3]
this_emg_montage = emg_montages['ovine_dsi']
...
for block_idx in block_idx_list:
    ...
    pdf_folder = Path(r"Z:\ISI\Phoenix" + f"{folder_name}") \ "figures"
    ...
    if folder_name in ['Day7_AM', 'Day8_AM', 'Day8_PM']:
        # for day8_AM block 4:
